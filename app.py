...
if __name__ == '__main__':
    # Initialize cache using sample inputs' time periods for development/first run
    initialize_cache() 
    
    # Run the Flask app
    # In production, Gunicorn handles the server. Here, we set the port for local testing.
    import os
